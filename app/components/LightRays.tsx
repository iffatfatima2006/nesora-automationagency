...
const LightRays = ({
    ...
    useEffect(() => {
        ...
        // Cleanup any previous instance immediately
        ...
        const initializeWebGL = async () => {
            ...
            if (!document.body.contains(currentContainer)) return;

            // Attempt to recover from lost context or limit
            ...
            if (!isMounted) {
                // If unmounted during creation, immediately destroy it
                if (renderer) {
            ...
            gl.canvas.style.pointerEvents = 'none'; // Ensure clicks pass through if needed

            // Clear container again just in case
...
void main() {
  ...
  gl_FragColor  = color;
            ...
            const updatePlacement = () => {
                ...
                const { clientWidth: wCSS, clientHeight: hCSS } = currentContainer;
            ...
            let lastFrameTime = 0;
            const targetFrameInterval = 1000 / 30; // Cap at 30fps for light rays (purely ambient)
